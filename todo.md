# Kit Mudança de Vida V2 - TODO

## Objetivos
- [x] Remover linhas preta e branca que deixam o design carregado
- [x] Criar design limpo e profissional
- [x] Manter todos os elementos de conversão
- [x] Garantir responsividade mobile-first
- [x] Otimizar velocidade de carregamento

## Features Principais
- [x] Hero section com headline impactante
- [x] Seção "Por Que Participar" com 3 benefícios
- [x] Seção "Como Funciona" com 3 passos
- [x] Seção "Ganhadores Reais" com prova social
- [x] FAQ com perguntas frequentes
- [x] CTA final persuasivo
- [x] Header fixo com logo e botão CTA
- [x] Footer com informações legais

## Design
- [x] Paleta de cores limpa (verde neon, amarelo, preto)
- [x] Remover bordas excessivas
- [x] Simplificar elementos visuais
- [x] Manter badges de credibilidade
- [x] Otimizar espaçamento e respiração visual

## Imagens
- [x] Fazer upload das imagens do site original
